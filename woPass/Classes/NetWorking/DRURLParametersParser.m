...
- (NSDictionary *)dictionaryForURL {
    
    NSMutableDictionary *dictionary = [NSMutableDictionary dictionary];
    [self.parameters enumerateObjectsUsingBlock:^(NSString *paramString, NSUInteger idx, BOOL *stop) {
        
        NSArray *keyValuse = [paramString componentsSeparatedByString:@"="];
        [dictionary setObject:keyValuse[1] forKey:keyValuse[0]];
    }];
