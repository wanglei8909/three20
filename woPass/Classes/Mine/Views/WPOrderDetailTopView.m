...
@implementation WPOrderDetailTopView


-(instancetype)init{
    self = [super initWithFrame:CGRectMake(0, 10, SCREEN_WIDTH, 127)];
    if (self) {
        self.backgroundColor = [UIColor whiteColor];
        UIView *back = [[UIView alloc]initWithFrame:CGRectMake(-1, 0, SCREEN_HEIGHT+2, 127)];
