...
@implementation WPOrderBuySucceedCtrl
...
-(void)viewDidLoad{
    ...
    for (int i = 0; i<2; i++) {
        ...
        UILabel *sLabel = [[UILabel alloc]initWithFrame:CGRectMake(100, i*45, 80, 45)];
        sLabel.backgroundColor = [UIColor clearColor];
        sLabel.text = i==0?@"10M流量":@"3元";
