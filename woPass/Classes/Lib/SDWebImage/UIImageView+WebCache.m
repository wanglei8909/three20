...
- (void)sd_setImageWithURL:(NSURL *)url {
    [self sd_setImageWithURL:url placeholderImage:nil options:0 | SDWebImageAllowInvalidSSLCertificates | SDWebImageDelayPlaceholder progress:nil completed:nil];
}
